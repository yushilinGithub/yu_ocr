...
def init(model_path, beam=5):
    model, cfg, task = fairseq.checkpoint_utils.load_model_ensemble_and_task(
        [model_path],
        arg_overrides={"beam": beam, "task": "text_recognition", "data": "", "fp16": False, "arch":"swin_tiny_patch4_window7","dict":"dictionary/mopai_chinese_support_TAL_mopai_formula.txt"})
...
if __name__ == '__main__':
    ...
    jpg_path = "/home/public/yushilin/formular/mopai/testData/"
