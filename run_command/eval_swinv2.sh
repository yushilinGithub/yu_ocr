...
export MODEL=/home/public/yushilin/ocr/model/handwrite/CASIA_64_336_swinv2/checkpoint_best.pt
export RESULT_PATH=/home/public/yushilin/ocr/result/handwrite/CASIA_64_336_swinv2
...
CUDA_VISIBLE_DEVICES=1 $(which fairseq-generate)  \
        --data-type HandWrite  --user-dir ./ --task handwrite_recognition --input-size 64-384 \
