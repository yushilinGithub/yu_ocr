...
@register_model
def DaViT_Tiny(pretrained, pretrained_cfg):
    depths = getattr(pretrained_cfg,"depths",(1, 1, 3, 1))
    num_heads = getattr(pretrained_cfg,"num_heads",(3, 6, 12, 24))
    embed_dims = getattr(pretrained_cfg,"embed_dims",(64, 128, 192, 256))
    model = DaViT(depths=depths, patch_size=4,
    ...
    return model
@register_model
def DaViT_Small(pretrained,pretrained_cfg):
    depths = getattr(pretrained_cfg,"depths",(1, 1, 3, 1))
    num_heads = getattr(pretrained_cfg,"num_heads",(3, 6, 12, 24))
    embed_dims = getattr(pretrained_cfg,"embed_dims",(64, 128, 192, 256))
    model = DaViT(depths=depths, patch_size=4,
