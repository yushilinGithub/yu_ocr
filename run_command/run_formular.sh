...
export MODEL_NAME=CASIA_64_336_swin
...
CUDA_VISIBLE_DEVICES=0 python $(which fairseq-train) --data-type HandWrite --input-size 112-336 --user-dir ./ --task handwrite_recognition  \
